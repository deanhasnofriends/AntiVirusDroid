...
public class TrialSplashScreen5bd0a7ed04a04513bd169fbaca507eda extends Activity {
	...
	protected void onCreate (Bundle bundle)
	{
		...
		task = new TimerTask () {
			...
			{
				finish ();
				Intent intent = new Intent (TrialSplashScreen5bd0a7ed04a04513bd169fbaca507eda.this, antivirusdroid.Activity1.class);
