...
namespace AntiVirus
{
    class Sprite
    {
        ...
        public Vector2 RelativeCenter2
        {
            get { return new Vector2(FrameWidth / 6, FrameHeight / 2); }
        }
        ...
        public virtual void UpdateEne(GameTime gameTime, string check)
        {
            if (!Expired)
            {
                float elapsed = (float)gameTime.ElapsedGameTime.TotalSeconds;
                ...
                if (Animate)
                {
                    if ((timeForCurrentFrame >= 0.5f) || check == "shot")
                    {
                        if (check == "ene")
                        {
                            currentFrame = (currentFrame + 1) % 2;
                            timeForCurrentFrame = 0.3f;
                        }
        ...
        public virtual void Update2(GameTime gameTime, string check)
        {
